...
internal class V1SecretResourceInformer : ResourceInformer<V1Secret, V1SecretList>
{
    ...
    {
        return Client.CoreV1.WatchListSecretForAllNamespacesAsync(resourceVersion: resourceVersion, fieldSelector: resourceSelector?.FieldSelector, onError: onError, cancellationToken: cancellationToken);
    }
}
