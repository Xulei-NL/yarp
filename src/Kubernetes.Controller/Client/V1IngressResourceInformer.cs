...
internal class V1IngressResourceInformer : ResourceInformer<V1Ingress, V1IngressList>
{
    ...
    protected override IAsyncEnumerable<(WatchEventType, V1Ingress)> WatchResourceListAsync(
        string resourceVersion = null, ResourceSelector<V1Ingress> resourceSelector = null,
        Action<Exception> onError = null, CancellationToken cancellationToken = default)
    {
        return Client.NetworkingV1.WatchListIngressForAllNamespacesAsync(resourceVersion: resourceVersion, fieldSelector: resourceSelector?.FieldSelector, onError: onError, cancellationToken: cancellationToken );
    }
}
