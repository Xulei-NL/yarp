...
internal class V1EndpointsResourceInformer : ResourceInformer<V1Endpoints, V1EndpointsList>
{
    ...
    {
        return Client.CoreV1.WatchListEndpointsForAllNamespacesAsync(resourceVersion: resourceVersion, fieldSelector: resourceSelector?.FieldSelector, onError: onError, cancellationToken: cancellationToken);
    }
}
