...
internal class V1IngressClassResourceInformer : ResourceInformer<V1IngressClass, V1IngressClassList>
{
    ...
    {
        return Client.NetworkingV1.WatchListIngressClassAsync(resourceVersion: resourceVersion, fieldSelector: resourceSelector?.FieldSelector, onError: onError, cancellationToken: cancellationToken);
    }
}
