...
internal class V1DeploymentResourceInformer : ResourceInformer<V1Deployment, V1DeploymentList>
{
    ...
    {
        return Client.AppsV1.WatchListDeploymentForAllNamespacesAsync(resourceVersion: resourceVersion, fieldSelector: resourceSelector?.FieldSelector, onError: onError, cancellationToken: cancellationToken);
    }
}
