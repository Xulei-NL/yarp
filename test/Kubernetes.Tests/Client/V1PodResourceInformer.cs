...
internal class V1PodResourceInformer : ResourceInformer<V1Pod, V1PodList>
{
    ...
    {
        return Client.CoreV1.WatchListPodForAllNamespacesAsync(resourceVersion: resourceVersion, fieldSelector: resourceSelector?.FieldSelector, onError: onError, cancellationToken: cancellationToken);
    }
}
